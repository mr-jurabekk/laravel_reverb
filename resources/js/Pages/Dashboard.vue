            ...
            <div>
                <div>
                    <div class="flex gap-5 relative sm:h-[calc(100vh_-_150px)] h-full sm:min-h-0" :class="{ 'min-h-[999px]': isShowChatMenu }">
                        <div
                            class="panel bg-white p-4 flex-none max-w-xs w-full absolute xl:relative z-10 space-y-4 h-full hidden xl:block overflow-hidden"
                        ...
                        >
                            <div class="flex justify-between items-center">
                                ...
                                <div class="dropdown">
                                    <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-start' : 'bottom-end'" offsetDistance="0">
                                        <button
                                            type="button"
                                            class="bg-[#f4f4f4] dark:bg-[#0e17261a] hover:bg-primary-light w-8 h-8 rounded-full !flex justify-center items-center hover:text-primary"
                                        >
                            ...
                            <div class="relative">
                                <input type="text" class="form-input w-full rounded border border-[#E0E6ED]" placeholder="Searching..." v-model="searchUser" />
                            ...
                            <div class="!mt-0">
                                <div class="overflow-y-auto chat-users relative h-full min-h-[100px] sm:h-[calc(100vh_-_357px)] space-y-0.5 ltr:pr-3.5 rtl:pl-3.5 ltr:-mr-3.5 rtl:-ml-3.5"
                                >
                                    <template v-for="person in searchUsers" :key="person.id">
                                        <button
                                            ...
                                            :class="{
                                    'bg-gray-100 dark:bg-[#0e17261a] dark:text-primary text-primary': selectedUser && selectedUser.userId === person.userId,
                                }"
                                            ...
                                            <div class="flex-1">
                                                <div class="flex items-center">
                                                    <div class="flex-shrink-0 relative">
                                                        <img :src="`/storage/assets/images/${person.path}`" class="rounded-full h-12 w-12 object-cover" />
                        ...
                        ></div>
                        <div class="panel bg-white p-0 flex-1">
                            ...
                            <template v-if="isShowUserChat && selectedUser">
                                <div class="relative h-full">
                                        ...
                                        <div class="flex sm:gap-5 gap-3">
                                            ...
                                            <div class="dropdown">
                                                <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-start' : 'bottom-end'" offsetDistance="0">
                                                    <button
                                                        type="button"
                                                        class="bg-[#f4f4f4] dark:bg-[#0e17261a] hover:bg-primary-light w-8 h-8 rounded-full !flex justify-center items-center"
                                                    >
                                    ...
                                    <div class="h-px w-full border-b border-[#e0e6ed] dark:border-[#0e17261a]"></div>
                                    <div class="relative overflow-y-auto h-full sm:h-[calc(100vh_-_300px)] chat-conversation-box">
                                    ...
                                    <div class="p-4 absolute bottom-0 left-0 w-full">
                                        <div class="sm:flex w-full space-x-3 rtl:space-x-reverse items-center">
                                            <div class="relative flex-1">
                                                <input
                                                    class="w-full form-input rounded-full border-0 bg-[#f4f4f4] px-12 focus:outline-none py-2"
                                                    placeholder="Type a message"
                                                    v-model="textMessage"
                                                    @keyup.enter.exact="sendMessage()"
                                                />
                                                <button type="button" class="absolute left-4  top-1/2 -translate-y-1/2 hover:text-primary">
                                                    <icon-mood-smile />
                                                </button>
                                                <button
                                                    type="button"
